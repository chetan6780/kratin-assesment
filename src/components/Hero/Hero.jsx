...
const Hero = () => {
    return (
        <section>
            <div className="bg-green-400" style={{backgroundImage:`url(${nature})`}}>
                <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 ">
                    <h1 className="text-5xl font-bold leading-none sm:text-6xl xl:max-w-3xl text-gray-600">Hey Sunita! let's enjoy life to it's fullest</h1>
